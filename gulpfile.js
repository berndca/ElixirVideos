...
gulp.task("copy:dev", ["copy:bower"], function () {
  return gulp.src(["src/index.html", "src/CNAME", "src/js/**/*", "src/assets/images/**/*", "src/data/elixir.json"])
...
gulp.task("watch", function () {
  ...
  gulp.watch(["src/index.html", "src/js/**/*.js", "src/html/**/*.html"], ["copy:dev", reload]);
